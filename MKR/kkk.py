...
def pre_scores():
    with tf.Session() as sess:
        ...
        for userid in range(2354):
            print(userid)
            item_id_data = head_id_data =[i for i in range(51204)]
...
if __name__ == '__main__':
    ...
    writer=open(r'D:\bysj\MusicRec\z-others\rec\data\user_song_prefer.txt','w',encoding='utf8')
    # print(index_user_id)
    try:
